          ...
          $.ajax({
              ...
              data: formData,
               ...
               success: function(data){
                ...
                var matchs = data.match("Wrong Email or Username");
                ...
                if (match!=null) {
                   $(this).hide();
                    ...
                    setTimeout(function(){
                window.location.href = '../app/reset_password';
                },5000);
                };
                if (matchs!=null) {
...
<div class="preloader-single mt-b-30">
  ...
  <!--===============================================================================================-->
                             <!--  <BEGINNING OF FORM> -->
        <form id="data" class="login100-form validate-form" style="height:400px" action="forgot_set.php" method="post">
