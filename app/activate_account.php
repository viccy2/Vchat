<!DOCTYPE html>
  <html>
  <head>
    <title>V-Chat Activate Account | V-Chat</title>
    <meta charset="utf-8">
        ...
        var formData = new FormData($("#data")[0]);
          ...
          $.ajax({
              ...
              success: function(data){
                ...
                $('#error').text(data);
                var b = data;
                 var match = data.match("Account activated successfully");
                var matchs = data.match("Incorrect Email or Activation Code Input");
                var matchss = data.match("Your account has been activated already");
                 var matchsss = data.match("All fields are required");
...
<div class="preloader-single mt-b-30">
  ...
  <!--===============================================================================================-->
                             <!--  <BEGINNING OF FORM> -->
        <form id="data" class="login100-form validate-form" style="height:400px" action="active.php" method="post">
          ...
          <div class="wrap-input100 validate-input" data-validate="Enter password">
            ...
            <input class="input100" type="password" name="activate" required>
            <span class="focus-input100" data-placeholder="Enter the Activation Code sent via Email"></span>
          </div>
