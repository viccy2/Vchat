          ...
          $.ajax({
              ...
              data: formData,
               ...
               success: function(data){
                ...
                $('#error').text(data);
                var b = data;
                var match = data.match("Successfull");
                var matchs = data.match("wrong information check your answer or try reset password via email");
                ...
                if (match!=null) {
                   $(this).hide();
                    ...
                    setTimeout(function(){
                window.location.href = '../app/change_password';
                },5000);
                };
                if (matchs!=null) {
...
<div class="preloader-single mt-b-30">
  ...
  <!--===============================================================================================-->
                             <!--  <BEGINNING OF FORM> -->
        <form id="data" class="login100-form validate-form" style="height:400px" action="reset2.php" method="post">
        ...
        while ($do=mysqli_fetch_array($save1)) {
          ...
          $_SESSION['user_forgot_answer']=$do['answer'];
               ...
               echo "$_SESSION[user_forgot_question]"; ?>
                         <!--   <?php
                                    session_start();
                                    require 'dc.php';
                                      echo "<p style='color:black;font-size:15px;font-weight:bold;' class='container animated zoomIn card card-body'>".$_SESSION['user_forgot_question']."</p>";
                                    ?> -->
                        </div>
