          ...
          $.ajax({
              ...
              success: function(data){
               ...
               var match = data.match("Password Reset Successfully");
                var matchs = data.match("password don't match");
                var matches = data.match("inputs cannot be empty");
                if (match!=null) {
                   $(this).hide();
                    ...
                    setTimeout(function(){
                window.location.href = '../app/edit_password';
                },5000);
                };
                if (matchs!=null) {
...
<div>
   <a href="edit_password"><i class="container-fluid fas fa-arrow-left fa-fw" style="color:white"></i></a>
</div>
         <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">
            ...
            <div>
             <p style="text-align:center;color:white;margin-top:8px;font-size:14px;">New Password</p>
 ...
 <div class="card__picture card__picture--2 ">
  ...
  <span class="card__heading-span card__heading-span--2" style="background:<?php echo $_SESSION['color']; ?>;font-family: inherit;font-size:20px">New Password</span>
  </h4>
 <div class="card__details">
  <form id="data" class="login100-form validate-form"  action="pass.php" method="post">
          ...
          <div class="wrap-input100 validate-input" data-validate="Confirm new password">
            ...
            <input class="input100" type="password" name="passwor" style="color:<?php echo $_SESSION['color']?>;">
