          ...
          $.ajax({
              ...
              data: formData,
               ...
               success: function(data){
                ...
                var matchs = data.match("Invalid security code, Try Security Question or Try again");
...
<div class="preloader-single mt-b-30">
  ...
  <!--===============================================================================================-->
                             <!--  <BEGINNING OF FORM> -->
        <form id="data" class="login100-form validate-form" style="height:400px" action="reset4.php" method="post">
          ...
          <div class="wrap-input100 validate-input" data-validate="Enter password">
            ...
            <span class="focus-input100" data-placeholder="Enter Validation Code Sent via Email"></span>
          </div><br><br>
