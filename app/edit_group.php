...
if (isset($_SESSION['user_id'])|| isset($_COOKIE['email']))
 {
  ...
  $_SESSION['j']=$jeremiah;
  $set=mysqli_query( $con, "select * from groupmember_tb where mememail= '$_SESSION[email]' and  group_id='$_SESSION[group_id]'");
...
<html>
  <head>
    <title>V-Chat Edit Group Info | V-Chat</title>
    <meta charset="utf-8">
...
<!--===============================================================================================-->
 ...
 <style type="text/css">
    body{
    background: <?php echo $_SESSION['bodybgcolo']; ?>;
  ...
  transition: all 0.4s;
    ...
    .card__picture--2 {
      background-image: url(<?php echo $_SESSION['group_picture'] ?>),linear-gradient(to right top, <?php echo $_SESSION['color']; ?>, rgba(0,0,0,0.2));
        height:50vh;
       }
...
<div>
   <a href="groupchat"><i class="container-fluid fas fa-arrow-left fa-fw" style="color:white"></i></a>
         ...
         <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">
            ...
            <div>
             <p style="text-align:center;color:white;margin-top:8px;font-size:14px;">Group Settings</p>
 ...
 <div class="card__picture card__picture--2 ">
  ...
  <span class="card__heading-span card__heading-span--2" style="background:<?php echo $_SESSION['color']; ?>;font-family: inherit;font-size:20px">Edit Group Info</span>
  </h4>
 <div class="card__details" style="color:gray">
 <form id="data" class="container-fluid login100-form validate-form"  action="gr_edit.php" method="post" enctype="multipart/form-data">
         
         
   
          <div class="wrap-input100 validate-input" data-validate = "">
            <input class="input100" type="text" name="username" value="<?php echo $_SESSION[group_mainname] ?>" style="color:<?php echo $_SESSION['color']?>;">
      ...
      <center>
            <input type="file" class="inputfile" name="fileToUpload" id="your_picture"  onchange="showPreview(this);" data-multiple-caption="{count} files selected" multiple hidden />
              ...
              <figure id="meme-bg-target">
                  <img src="<?php echo $_SESSION[group_picture] ?>" alt="" class="your_picture_image" style="height:100px;width:100px;border-radius:50%">
                   <p class="text-gray-600">Choose Picture</p>
              </figure>
    ...
    if (objFileInput.files[0]) 
    {
        ...
        fileReader.readAsDataURL(objFileInput.files[0]);
            ...
            <div class="text-center u-margin-top-big">
                <a href="edit_profile" id="submit" class="btn text-gray-700" >Save changes</a>
            </div>          
