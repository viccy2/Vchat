...
<div>
   <a href="settings"><i class=" fas fa-arrow-left fa-fw" style="color:white"></i></a>
</div>
         <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">
            ...
            <div>
             <p style="text-align:center;color:white;margin-top:8px;font-size:14px;">Account Settings</p>
...
<!--===============================================================================================-->
  <div class=" animated zoomIn" style="background: -webkit-linear-gradient(top,<?php echo $_SESSION['headerbgcolor']?>,rgba(0, 0, 0, 0.15));opacity:0.9;margin-top:18px;min-height:100vh;
     max-height:1000vh;">
     
     <div class="conta" style="color:white;background:white;color:<?php echo $_SESSION['color']?>;height:40px;">
      <p style="padding:10px">Profile Settings</p>
    </div>
    <a href="edit_profile">
    <div class="" style="margin-top:20px">
      <p class="container-fluid" style="color:white">Edit Profile</p>
      <hr style='background-color:white'></hr>
    </div>
  </a>
  <a href="edit_walpaper">
    <div class="" style="margin-top:20px">
      <p class="container-fluid" style="color:white">Edit Wallpaper</p>
      <hr style='background-color:white'></hr>
    </div>
  </a>
  <a href="edit_theme">
    <div class="" style="margin-top:20px">
      <p class="container-fluid" style="color:white">Edit Theme</p>
   
    </div>
  </a><br>
   <div class="conta" style="color:white;background:white;color:<?php echo $_SESSION['color']?>;height:40px;margin-top:-10px">
      <p style="padding:10px">Login Settings</p>
    </div>
    <a href="edit_password">
    <div class="" style="margin-top:20px">
      <p class="container-fluid" style="color:white">Change Password</p>
     
    </div>
  </a><br>
  <div class="conta" style="color:white;background:white;color:<?php echo $_SESSION['color']?>;height:40px;">
      <p style="padding:10px">Security Settings</p>
    </div>
    <a href="#">
    <div class="" style="margin-top:20px">
      <p class="container-fluid" style="color:white">Security</p>
      <hr style='background-color:white'></hr>
    </div>
  </a>
  </div>
