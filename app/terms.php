...
<html>
  <head>
    <title>V-Chat Terms and Privacy | V-Chat</title>
    <meta charset="utf-8">
...
<div>
   <a href="settings"><i class="container-fluid fas fa-arrow-left fa-fw" style="color:white"></i></a>
         ...
         <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">
            ...
            <div>
             <p style="text-align:center;color:white;margin-top:8px;font-size:14px;">Terms and Privacy</p>
  ...
  <div class="containe">
    <div class="car" style="background: -webkit-linear-gradient(top,<?php echo $_SESSION['headerbgcolor'];?>,rgba(0, 0, 0, 0.15));opacity:0.9;border-color:<?php echo $_SESSION['color'];?>;  min-height:100vh;
     max-height:1000vh; ">
