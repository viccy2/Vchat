...
<!-- Topbar Search -->
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" style="width:50%;">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small searchnow" placeholder="Search for all members"  onkeyup="request(this.value)" id="search" style="height:36px;font-size: 13px;" >
            </div>
          </form>
         <!-- Topbar Navbar -->
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
              ...
              <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in animated zoomIn" aria-labelledby="searchDropdown" style="margin-top:-20px">
                ...
                <form class="form-inline mr-auto w-100 navbar-search" >
                  <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small searchnow" placeholder="Search for all members"  onkeyup="request(this.value)" id="search2">
                  </div>
                </form>
              </div>
            </li>
        ...
        function request(s)
         ...
         out += "<div  class=' slideInRight chip bg-gray-300' style='color:<?php echo $_SESSION['color'] ?>;font-size:12px;width:100%'>  <img src='"+arr[i].memberpic+"' alt='' />"+arr[i].username+"<button onclick='add("+arr[i].member_id+")' data-toggle='modal' data-target='#addModal'  title='Add as Friend' class='btn pd-setting-ed' style='float:right;height:50px'><i class='fa fa-plus' aria-hidden='true'></i></button><br> </div><br><br> </div> </div>";
          }
          $('#chatbox').html(out);
            });
           }
   ...
   <form action="group_add_friends" method="post" id="formals" hidden>
  <input type="text" name="id" value="" id='abc'>
