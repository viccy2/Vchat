...
<html>
  <head>
    <title>V-Chat Edit Wallpaper | V-Chat</title>
    <meta charset="utf-8">
        ...
        var formData = new FormData($("#data")[0]);
          ...
          $.ajax({
              ...
              success: function(data){
                ...
                $('#error').text(data);
                var b = data;
                var match = data.match("Wallpaper changed successfully");
                var matchs = data.match("your image type is unacceptable");
                var matches = data.match("your image is too small for a wallpaper");
                if (match!=null) {
                   $(this).hide();
...
<div>
   <a href="account_settings"><i class="container-fluid fas fa-arrow-left fa-fw" style="color:white"></i></a>
         ...
         <!-- Topbar Navbar -->
          <ul class="navbar-nav ml-auto">
            ...
            <div>
             <p style="text-align:center;color:white;margin-top:8px;font-size:14px;">Edit Wallpaper</p>
 ...
 <div class="card__side card__side--front"  style="background:linear-gradient(to left top, <?php echo $_SESSION['bodybgcolor']; ?>, rgba(0,0,0,0.2));height:600px;min-height:100vh;
     max-height:1000vh;">
 <div class="card__picture card__picture--2">

  </div>
  <h4 class="card__heading" style="margin-top:80px">
  <span class="card__heading-span card__heading-span--2" style="background:<?php echo $_SESSION['color']; ?>;font-family: inherit;font-size:20px">Edit Wallpaper</span>
  </h4>
 <div class="card__details" style="color:gray">
  <form id="data" class="container-fluid login100-form validate-form"  action="walps.php" method="post">
      ...
      <center>
             <input type="file" class="inputfile" name="fileToUpload" id="your_picture"  onchange="showPreview(this);" data-multiple-caption="{count} files selected" multiple hidden />
              ...
              <figure id="meme-bg-target">
                  <img src="<?php echo $_SESSION[walpss] ?>" alt="" class="your_picture_image" style="height:100px;width:100px;border-radius:50%">
                   <p class="text-gray-500" style="color:white">Choose Picture</p>
              </figure>
